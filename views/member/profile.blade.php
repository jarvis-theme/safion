<div class="top-list container">
    <h2 class="title"><i class="fa fa-user"></i> &nbsp;Edit Profil</h2>
    <div class="clr"></div>
    <hr>
</div>
	...
	<div class="inner-column row">
        <div id="left_sidebar" class="col-md-3">
            <div id="advertising" class="block">
            	...
            	<ul class="nav">
					<li><a href="{{url('member')}}">Order Histori</a></li>                         
					<li class="active"><a href="{{url('member/profile/edit')}}">Edit Profil</a></li>
				</ul>
            </div>            
        </div>
